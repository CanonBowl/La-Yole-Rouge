...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getReservationControllerService()
    {
        ...
        $this->services['App\\Controller\\ReservationController'] = $instance = new \App\Controller\ReservationController(($this->privates['App\\Repository\\ReservationRepository'] ?? $this->getReservationRepositoryService()), ($this->privates['App\\Repository\\EtatReservationRepository'] ?? $this->getEtatReservationRepositoryService()));
    ...
    protected function getUserControllerService()
    {
        ...
        $this->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WztZtxjrEn', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4A13r3LiPl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\EtatReservationRepository' => ['privates', 'App\\Repository\\EtatReservationRepository', 'getEtatReservationRepositoryService', false],
            ...
            'App\\Repository\\EtatReservationRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.I8VW4yW' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_I8VW4yWService()
    {
        return $this->privates['.service_locator.I8VW4yW'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ReservationController::gerer_reservation' => ['privates', '.service_locator.5sWVEo_', 'get_ServiceLocator_5sWVEoService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.q6jLs_L', 'get_ServiceLocator_Q6jLsLService', false],
            'App\\Controller\\UserController::register' => ['privates', '.service_locator.brwnFo5', 'get_ServiceLocator_BrwnFo5Service', false],
            'App\\Controller\\ReservationController:gerer_reservation' => ['privates', '.service_locator.5sWVEo_', 'get_ServiceLocator_5sWVEoService', false],
            'App\\Controller\\SecurityController:login' => ['privates', '.service_locator.q6jLs_L', 'get_ServiceLocator_Q6jLsLService', false],
            'App\\Controller\\UserController:register' => ['privates', '.service_locator.brwnFo5', 'get_ServiceLocator_BrwnFo5Service', false],
        ], [
            'App\\Controller\\ReservationController::gerer_reservation' => '?',
    ...
    /**
     * Gets the private '.service_locator.brwnFo5' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_BrwnFo5Service()
    {
        return $this->privates['.service_locator.brwnFo5'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'passEncoder' => ['services', 'security.password_encoder', 'getSecurity_PasswordEncoderService', false],
        ], [
            'passEncoder' => '?',
        ]);
    }
    ...
    /**
     * Gets the private 'App\Form\AddReservationType' shared autowired service.
     *
     * @return \App\Form\AddReservationType
     */
    protected function getAddReservationTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\AddReservationType.php';

        return $this->privates['App\\Form\\AddReservationType'] = new \App\Form\AddReservationType();
    }
     ...
     */
    protected function getEditReservationTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\EditReservationType.php';

        return $this->privates['App\\Form\\EditReservationType'] = new \App\Form\EditReservationType();
    }
    ...
    /**
     * Gets the private 'App\Repository\EtatReservationRepository' shared autowired service.
     *
     * @return \App\Repository\EtatReservationRepository
     */
    protected function getEtatReservationRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\EtatReservationRepository.php';

        return $this->privates['App\\Repository\\EtatReservationRepository'] = new \App\Repository\EtatReservationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getLoginAuthentificatorAuthenticatorService()
    {
        ...
        return $this->privates['App\\Security\\LoginAuthentificatorAuthenticator'] = new \App\Security\LoginAuthentificatorAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FVugsd6Y2e', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lCvGcHIf2p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EamBRrFTL3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('e4EhoU5v6o', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mS-ksMeqbi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\AddReservationType', 1 => 'App\\Form\\EditReservationType', 2 => 'App\\Form\\UserType', 3 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 6 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\EtatReservationFixtures.php';

        $a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\EtatReservationFixtures(), 'groups' => []]]);
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\AddReservationType' => ['privates', 'App\\Form\\AddReservationType', 'getAddReservationTypeService', false],
            'App\\Form\\EditReservationType' => ['privates', 'App\\Form\\EditReservationType', 'getEditReservationTypeService', false],
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Informations'), [0 => 'ROLE_USER'], NULL);
    ...
    protected function getSecurity_Authentication_Listener_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.main'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\LoginAuthentificatorAuthenticator'] ?? $this->getLoginAuthentificatorAuthenticatorService());
